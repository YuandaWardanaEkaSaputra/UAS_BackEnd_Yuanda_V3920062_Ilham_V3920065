...
<footer class="footer  d-print-none">
	<div class="container-fluid clearfix">
		<span class="text-muted d-block text-center text-sm-left d-sm-inline-block">yaunda <a href="#">ilham</a>. ganteng.</span>
		<span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Repost by <a href="https://stokcoding.com/" title="StokCoding.com" target="_blank">Yuanda</a> | Hand-crafted & made with <i class="mdi mdi-heart text-danger"></i></span>
	</div>
</footer>
<!-- partial -->
</div>
