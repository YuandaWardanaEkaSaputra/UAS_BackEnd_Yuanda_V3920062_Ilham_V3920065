...
class PesanController extends CI_Controller
{
	...
	public function pesanSpanduk()
	{
		...
		$data = array(
			'title' => 'Pesan Spanduk | Yuail Digital Printing'
		);
	...
	public function pesanStiker(){
		...
		$data = array(
			'title' => 'Pesan Stiker | Yuail Digital Printing'
		);
		$this->load->view('frontend/templates/header',$data);
	...
	public function pesanKartu(){
		...
		$data = array(
			'title' => 'Pesan Kartu Nama | Yuail Digital Printing'
		);
		$this->load->view('frontend/templates/header',$data);
	...
	public function pesanBrosur(){
		...
		$data = array(
			'title' => 'Pesan Brosur | Yuail Digital Printing'
		);
		$this->load->view('frontend/templates/header',$data);
